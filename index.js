// Code from when starting Alexa Developer Console, custom skill and choosing Quiz Game Skill Template
...
//villager dataframe 
const data = [
  {villagername: 'Marshall', Personality: 'smug', Species: 'squirrel', Birthdayday: 29, Birthdaymonth: 'September'},
  {villagername: 'Alfonso', Personality: 'lazy', Species: 'alligator', Birthdayday: 9, Birthdaymonth: "June"},
  {villagername:'Lucky', Personality: 'lazy', Species: 'dog',  Birthdayday:11, Birthdaymonth: "November"},
  {villagername: 'Freckles', Personality: 'peppy', Species: 'duck', Birthdayday: 19, Birthdaymonth:"Feburary"},
  {villagername: 'Apple', Personality: 'peppy', Species: 'hamster',  Birthdayay: 24, Birthdaymonth: "September"},
  {villagername: 'Biff', Personality: 'jock', Species: 'hippo', Birthdayay: 29, Birthdaymonth:"March"},
  {villagername: 'Stella', Personality: 'normal', Species: 'sheep', Birthdayday: 9, Birthdaymonth:"April"},
  {villagername: 'Claudia', Personality: 'snooty', Species: 'tiger', Birthdayday: 22, Birthdaymonth: "November"},
  {villagername: 'Pheobe', Personality: 'big sister', Species: 'ostrich', Birthdayay: 22, Birthdaymonth: "April"},
  {villagername: 'Elvis', Personality: 'cranky', Species: 'lion', Birthdayday: 23, Birthdaymonth:"July"},
  {villagername: 'Becky', Personality: 'snooty', Species: 'chicken', Birthdayday: 12, Birthdaymonth:"December" },
  {villagername: 'Eugene', Personality: 'smug', Species: 'koala', Birthdayday: 26, Birthdaymonth:"October" },
  {villagername: 'Pancetti', Personality: 'snooty', Species: 'pig', Birthdayday: 14, Birthdaymonth:"November" },
  {villagername: 'Dobie', Personality: 'cranky', Species: 'wolf', Birthdayday: 17, Birthdaymonth:"Feburary" },
  {villagername: 'Samson', Personality: 'jock', Species: 'mouse', Birthdayday: 9, Birthdaymonth:"July" },
  {villagername: 'Cousteau', Personality: 'jock', Species: 'frog', Birthdayday: 17, Birthdaymonth:"December" },
  {villagername: 'Chester', Personality: 'lazy', Species: 'cub', Birthdayday: 6, Birthdaymonth:"August" },
  {villagername: 'Annalisa', Personality: 'normal', Species: 'anteater', Birthdayday: 6, Birthdaymonth:"Feburary" },
  {villagername: 'Anchovy', Personality: 'lazy', Species: 'bird', Birthdayday: 4, Birthdaymonth:"March" },
  {villagername: 'Papi', Personality: 'lazy', Species: 'horse', Birthdayday: 10, Birthdaymonth:"January" },
...
const welcomeMessage = `Welcome to the Animal Crossing Villager Quiz Game!  You can ask me about any of the villagers, or you can ask me to start a quiz.  What would you like to do?`;
const startQuizMessage = `Quiz it is!  I will ask you 10 questions about Animal Crossing Villagers. `;
const exitSkillMessage = 'Thanks for playing the Animal Crossing Villager Quiz! I hope we play again soon';
const repromptSpeech = `Which other villager would you like to know about?`;
const helpMessage = `I know lots of things about Animal Crossing villagers.  You can ask me about a villager, and I'll tell you what I know.  You can also test your knowledge by asking me to start a quiz.  What would you like to do?`;
...
function getSpeechDescription(item) {
    return `${item.villagername} is a ${item.Personality}  ${item.Species} , whose birthday is ${item.Birthdayday} ${item.Birthdaymonth}. Is there any other villager you would like to know about?`;
}
...
function getQuestion(counter, property, item) {
  return `Here is your ${counter}th question.  What is the ${formatCasing(property)} of ${item.villagername}?`;
}
...
function getQuestionWithoutOrdinal(property, item) {
  return "What is the " + formatCasing(property).toLowerCase() + " of "  + item.villagername + "?";
}

function getAnswer(property, item) {
  switch (property) {
    case 'Abbreviation':
      return `The ${formatCasing(property)} of ${item.villagername} is <say-as interpret-as='spell-out'>${item[property]}</say-as>. `;
    default:
      return `The ${formatCasing(property)} of ${item.villagername} is ${item[property]}. `;
  }
}
